...
from prep_data import JsonToVec, InitVec, BinaryDataSet
...
def load_memory_datasets(train_dataset_name_labels, test_dataset_name_labels):
    ...
    return BinaryDataSet(train_dataset), BinaryDataSet(test_dataset)
...
def main():
    ...
    parser.add_argument('--train', '-i', nargs='+', required=True,
                        help='Train data')
    parser.add_argument('--test', '-t', nargs='+', required=True,
                        help='Test data')
    ...
    train, test = load_memory_datasets(args.train,
                                       args.test)
