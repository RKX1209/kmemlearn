...
static int handle_ept_misconfig(struct kvm_vcpu *vcpu)
{
	...
	gpa = vmcs_read64(GUEST_PHYSICAL_ADDRESS);
	/* RKX:
	 * If EPT misconfig happen due to irregular page permission like -w-,
	 * kmemlearn should handle it.
	*/
	ret = handle_irregular_perm (vcpu, gpa);
	if (unlikely(ret))
		return 1;
