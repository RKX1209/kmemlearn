...
#define TASK_threadsp 2784 /* offsetof(struct task_struct, thread.sp) */
#define TASK_stack_canary 1312 /* offsetof(struct task_struct, stack_canary) */

#define TASK_TI_flags 0 /* offsetof(struct task_struct, thread_info.flags) */
#define TASK_addr_limit 2920 /* offsetof(struct task_struct, thread.addr_limit) */
