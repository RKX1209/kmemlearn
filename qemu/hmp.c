...
void hmp_kvm_hook_start(Monitor *mon, const QDict *qdict) {
  Error *err = NULL;
  qmp_kvm_hook_start(&err);
}

void hmp_kvm_hook_stop(Monitor *mon, const QDict *qdict) {
  Error *err = NULL;
  qmp_kvm_hook_stop(&err);
}

void hmp_kvm_hook_flush(Monitor *mon, const QDict *qdict) {
  Error *err = NULL;
  qmp_kvm_hook_flush(&err);
}

void hmp_kvm_hook_log(Monitor *mon, const QDict *qdict) {
  Error *err = NULL;
