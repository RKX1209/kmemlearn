...
ETEXI
...

    {
        ...
        .args_type  = "",
        .params     = "",
        .help       = "start hook by KVM(kmemlearn)",
        .cmd        = hmp_kvm_hook_start,
    },

STEXI
@item hook_start_kvm
@findex hook_start_kvm
Start hook by KVM
ETEXI

    {
        ...
        .args_type  = "",
        .params     = "",
        .help       = "stop hook by KVM(kmemlearn)",
        .cmd        = hmp_kvm_hook_stop,
    },

STEXI
@item hook_stop_kvm
@findex hook_stop_kvm
Stop hook by KVM
ETEXI

    {
        ...
        .args_type  = "",
        .params     = "",
        .help       = "flush hook by KVM(kmemlearn)",
        .cmd        = hmp_kvm_hook_flush,
    },
...
ETEXI

    {
        ...
        .args_type  = "",
        .params     = "",
        .help       = "get access log from KVM(kmemlearn)",
        .cmd        = hmp_kvm_hook_log,
    },

STEXI
@item hook_stop_kvm
@findex hook_stop_kvm
Get access log from KVM
ETEXI
